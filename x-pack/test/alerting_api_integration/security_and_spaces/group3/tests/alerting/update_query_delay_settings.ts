          ...
          switch (scenario.id) {
            ...
            case 'space_1_all at space1':
              ...
              expect(response.body).to.eql({
                error: 'Forbidden',
                message:
                  'API [GET /internal/alerting/rules/settings/_query_delay] is unauthorized for user, this action is granted by the Kibana privileges [write-query-delay-settings]',
                statusCode: 403,
              });
              break;
